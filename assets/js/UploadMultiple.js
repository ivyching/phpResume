...
class UploadMultiple extends  UploadFile{
    ...
    initialDropZone(){
        ...
        var attachmentDropZone = new Dropzone("#"+self.field+" div.js-attachment-dropzone", {
            url: Routing.generate('upload_multipleFiles', {uuid: self.uuid, fieldName: self.field,func:self.func}),
            paramName: 'file',
            uploadMultiple: true,
    ...
    refreshData(){
        var self = this;
        $.ajax({
            url: Routing.generate("refresh_all_files", {uuid: self.uuid,fieldName:self.field}),
            method: 'POST',
            datatype: 'json',
